...
class ConcetricDiceLoss(_Loss):
    ...
    def forward(self, y_pred: torch.Tensor, y_true: torch.Tensor) -> torch.Tensor:
        ...
        square_mask = self.square_mask[None,None,...].to(y_pred.device)  ## 1,1,H,W
        ...
        if self.mode == MULTICLASS_MODE:
            ...
            elif self.square_mask is not None:
                y_pred = y_pred.view(bs, num_classes, -1)*square_mask.view(1,1,-1)
